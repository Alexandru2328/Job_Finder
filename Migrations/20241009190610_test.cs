        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeywordList = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Id_Traking = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "4b3ab00c-67b3-4a87-bf6f-6e3da5a7ce93", null, "admin", "client" },
                    { "677f5486-015f-4d56-bb75-92bbd8060b2e", null, "client", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_UserNotificationId",
                table: "AspNetUsers",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_UserNotifications_UserNotificationId",
                table: "AspNetUsers",
                column: "UserNotificationId",
